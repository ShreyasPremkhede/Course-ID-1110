...
\begin{align}
x &= \frac {3-\mu}{\sqrt{2} \sigma}\\
x &= \frac {3-1}{\sqrt{1.8}}\\
x &= 1.490711985
\end{align}
$\therefore \, erf(x)$ implies,
\begin{align}
erf(1.490711985) &= \int_{0}^{1.490711985} \frac{1}{\sqrt{2\pi}} e^{-x^2}dx\\
erf(1.490711985) &= 0.9649836\\
F_X(3) &= 0.5 \cdot (1 + erf(1.490711985))\\
F_X(3) &= 0.9824918\\
P(X \geq 4) &= 1 - F_X(3)\\
	    &= 1 - 0.9824918\\
	    &= 0.0175082
...
\(0.0175082 - 0.0127951893 = 0.004713011\)
